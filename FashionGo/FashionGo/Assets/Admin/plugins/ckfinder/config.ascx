...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        PluginSettings.Add("ImageResize_smallThumb", "80x120" );
        PluginSettings.Add("ImageResize_mediumThumb", "200x300" );
        PluginSettings.Add("ImageResize_largeThumb", "400x600" );
        // Name of the watermark image in plugins/watermark folder
        PluginSettings.Add("Watermark_source", "~/Content/images/logo-fashiongo.png" );
        PluginSettings.Add("Watermark_marginRight", "5" );
        PluginSettings.Add("Watermark_marginBottom", "5" );
        PluginSettings.Add("Watermark_quality", "80" );
        PluginSettings.Add("Watermark_transparency", "60" );
