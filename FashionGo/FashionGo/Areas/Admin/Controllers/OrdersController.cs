...
namespace FashionGo.Areas.Admin.Controllers
{
    public class OrdersController : Controller
    {
        ...
        //private readonly ViewEngineCollection _viewEngine;
        ...
        //public async Task<ActionResult> RenderToPdf()
        //{
        //    var model = GetData();

        //    // Chuyển đổi trang cshtml thành PDF
        //    var html = ViewToString("Index", model);
        ...
        //    // Trả về PDF
        //    File(pdf, "application/pdf", "output.pdf");
